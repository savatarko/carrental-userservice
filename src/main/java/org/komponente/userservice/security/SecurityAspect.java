package org.komponente.userservice.security;
...
public class SecurityAspect {
    ...
    //@Around("@annotation(com.raf.cinemamovieservice.secutiry.CheckSecurity)")
    @Around("@annotation(org.komponente.userservice.security.CheckSecurity)")
